...
* * *
## Python3 Django web framework 기반 (elasticsearch database server는 용량 관계상 생략. raw content: https://github.com/drexly/movie140reviewcorpus)
